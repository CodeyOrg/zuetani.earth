...
import { FirebaseDataService, type Post, type User, FirebaseAuthService } from "@/lib/firebase-auth"
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        setPosts(postsData)
        // Note: Users data loading will be implemented separately since we're focusing on Firebase users
