...
import { DataService, type Post, type User } from "@/lib/auth"
...
export default function SearchPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const [postsData, usersData] = await Promise.all([DataService.searchPosts(query), DataService.searchUsers(query)])
      setPosts(postsData)
      setUsers(usersData)
    } catch (error) {
